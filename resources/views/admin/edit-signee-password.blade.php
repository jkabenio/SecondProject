...
.change_pass_signee_edit_view{
padding-top: 39px;
}
.change_pass_signee-column{
    width: 50%;
    float: left;
}
</style>
<div class="change_pass_signee_edit_view">
    <div class="card" style="border: 2px solid black; margin-left: 0.3px;">
        <div class="card-header">
            ...
            <h4  style="text-align: center"><b>Edit Password</b>
                <a href="{{url('/admin/change-signee-password')}}" class="btn btn-danger float-end">BACK</a>
            </h4>
        </div>
        {!! Form::open(['action' => ['App\Http\Controllers\Admin\AdminController@update_signee_password',$signee_id->id],'enctype' => 'multipart/form-data']) !!}
        <div class="card-body">
            @csrf 
            @method('PUT')
            ...
            <div class="form-group mb-3">
                ...
                <h5  style="text-align: center">You are about to change <b>{{$signee_id->name}}</b> password!<br>Proceed with caution.</h5>
            </div>

            <div class="change_pass_signee-column">
