    ...
    <div class="row justify-content-center">
        <div class="">
            <div class="card_login">
                <div class="index_title"><img class="ollcf_logo_css" src = "{{ asset('/img/Ollfc_Logo.png') }}" alt="Italian Trulli"/><b>{{ __('Signee E-Clearance') }}</b></div>

                <div class="card-body">
                    {!! Form::open(['action' => 'App\Http\Controllers\Signee\SigneeController@check', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label remember_me_label" for="remember">
                                        {{ __('Remember Me') }}
                                    </label>
                                </div>
                            </div>
